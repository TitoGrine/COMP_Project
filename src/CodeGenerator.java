...
public class CodeGenerator {
    ...
    static void makeOperation(Node operationNode) {
        ...
        if (oper1.id == ParserTreeConstants.JJTADD || oper1.id == ParserTreeConstants.JJTMUL
                || oper1.id == ParserTreeConstants.JJTSUB || oper1.id == ParserTreeConstants.JJTDIV
                || oper1.id == ParserTreeConstants.JJTAND || oper1.id == ParserTreeConstants.JJTLESSTHAN) {
        ...
        if (oper2.id == ParserTreeConstants.JJTADD || oper2.id == ParserTreeConstants.JJTMUL
                || oper2.id == ParserTreeConstants.JJTSUB || oper2.id == ParserTreeConstants.JJTDIV
                || oper2.id == ParserTreeConstants.JJTAND || oper2.id == ParserTreeConstants.JJTLESSTHAN) {
    ...
    static void methodBody(Node methodBodyChilds[]) {
        for (Node candidate : methodBodyChilds)
            if (((SimpleNode) candidate).id == ParserTreeConstants.JJTASSIGN) {
                switch (((SimpleNode) candidate.jjtGetChild(1)).id) {
    ...
    static void popReturn(Node funcMethod) {
        if (getMethodReturnType(funcMethod) == TypeEnum.VOID)
            return;
